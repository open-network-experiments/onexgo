...
import (
	...
	onexdatamodel "github.com/ajbalogh/open-network-experiments/artifacts/godatamodel/onexdatamodel"
...
func (api *godatamodelApi) grpcConnect() error {
...
func (api *godatamodelApi) grpcClose() error {
	if api.grpc != nil {
...
func (api *godatamodelApi) Close() error {
...
func NewApi() GodatamodelApi {
	api := godatamodelApi{}
	return &api
}

// httpConnect builds up a http connection
func (api *godatamodelApi) httpConnect() error {
...
func (api *godatamodelApi) httpSendRecv(urlPath string, jsonBody string, method string) (*http.Response, error) {
	err := api.httpConnect()
	if err != nil {
		return nil, err
	}
...
// GodatamodelApi the data models for the entire ONEx ecosystem
type GodatamodelApi interface {
	Api
...
func (api *godatamodelApi) NewConfig() Config {
	return NewConfig()
}

func (api *godatamodelApi) NewConfigRequest() ConfigRequest {
	return NewConfigRequest()
}

func (api *godatamodelApi) NewExperimentRequest() ExperimentRequest {
	return NewExperimentRequest()
}

func (api *godatamodelApi) NewMetricsRequest() MetricsRequest {
	return NewMetricsRequest()
}

func (api *godatamodelApi) NewSetConfigResponse() SetConfigResponse {
	return NewSetConfigResponse()
}

func (api *godatamodelApi) NewGetConfigResponse() GetConfigResponse {
	return NewGetConfigResponse()
}

func (api *godatamodelApi) NewRunExperimentResponse() RunExperimentResponse {
	return NewRunExperimentResponse()
}

func (api *godatamodelApi) NewGetMetricsResponse() GetMetricsResponse {
	return NewGetMetricsResponse()
}

func (api *godatamodelApi) SetConfig(config Config) (WarningDetails, error) {
...
func (api *godatamodelApi) GetConfig(configRequest ConfigRequest) (ConfigResponse, error) {
...
func (api *godatamodelApi) RunExperiment(experimentRequest ExperimentRequest) (WarningDetails, error) {
...
func (api *godatamodelApi) GetMetrics(metricsRequest MetricsRequest) (MetricsResponse, error) {
...
func (api *godatamodelApi) httpSetConfig(config Config) (WarningDetails, error) {
...
func (api *godatamodelApi) httpGetConfig(configRequest ConfigRequest) (ConfigResponse, error) {
...
func (api *godatamodelApi) httpRunExperiment(experimentRequest ExperimentRequest) (WarningDetails, error) {
...
func (api *godatamodelApi) httpGetMetrics(metricsRequest MetricsRequest) (MetricsResponse, error) {
